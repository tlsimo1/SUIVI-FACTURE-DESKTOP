...
namespace Suivie_Facture
{
    public partial class form_param : Form
    {
        ...
        private void dg_param2_EditingControlShowing(object sender, DataGridViewEditingControlShowingEventArgs e)
        {
            //if (e.Control.inde == 2)//select target column
            //{
        ...
        private void dg_param2_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
