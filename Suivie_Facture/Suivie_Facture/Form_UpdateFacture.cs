    ...
    public partial class Form_UpdateFacture : Form
    {
        ...
        private void Form_UpdateFacture_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //txt_codf.Text = dtUpdate.Rows[0]["Code Fournisseur"].ToString();
                ...
                //string aze = dtUpdate.Rows[0]["Assistante DAF"].ToString();
                dt_ass.Text = (dtUpdate.Rows[0]["Assistante DAF"].ToString() == "01/01/1900 00:00:00") ? null : dtUpdate.Rows[0]["Assistante DAF"].ToString();
                ...
                //dte_test.Text = (dtUpdate.Rows[0]["Chef Comptable"].ToString() == "01/01/1900 00:00:00") ? " " : dtUpdate.Rows[0]["Chef Comptable"].ToString();
        ...
        private void btn_validerUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //MyDynamic.COD_FOU = txt_codf.Text;
        ...
        private void btn_validerUpdate_Click_1(object sender, EventArgs e)
        {
            btn_validerUpdate_Click(sender, e);
        }
    }
}
